chrome.storage.sync.get("extensionEnabled", ({ extensionEnabled }) => {
  if (extensionEnabled === false) {
    console.log("Anti-cyberbullying script is OFF");
    stopObserver();
  } else {
    console.log("Anti-cyberbullying script is ON");
    initObserver();
  }
});
...
chrome.storage.onChanged.addListener((changes) => {
  if (changes.extensionEnabled) {
    if (changes.extensionEnabled.newValue === false) {
      console.log("Disabling anti-cyberbullying script");
      stopObserver();
    } else {
      console.log("Enabling anti-cyberbullying script");
      initObserver();
    }
  }
});
